    ...
    return (
        <aside className='bg-[#1e1f20] w-72 text-white flex flex-col h-full overflow-hidden shrink-0 transition-all shadow-lg z-100 duration-300'>
            <div className='px-4 flex flex-col gap-2 mb-12'>
                ...
                <button className='flex items-center gap-3 bg-[#131314] hover:bg-[#282a2c] text-sm font-medium py-2.5 px-4 rounded-full font-deskripsi w-max duration-300 transition-colors hover:cursor-pointer active:bg-neutral-600 '>
            ...
            <div className='flex-1 overflow-y-auto mt-2 font-deskripsi'>
                <h3 className='text-xs font-semibold text-neutral-400 mb-3 px-6'>Recent</h3>
                <div className='flex flex-col gap-1'>
                    <div className='flex items-center gap-3 px-3 py-2  hover:bg-neutral-800 cursor-pointer text-sm text-neutral-200 transition-colors truncate'>
